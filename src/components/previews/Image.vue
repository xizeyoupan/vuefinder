<template>
  <div class="flex">
    <h3 class="mb-2 text-lg leading-6 font-medium text-gray-900 dark:text-gray-400" id="modal-title"
      :aria-label="selection.item.path" data-microtip-position="bottom-right" role="tooltip">{{ selection.item.basename }}
    </h3>
  ...
  <div class="w-full flex justify-center">
    <img :crossorigin="crossorigin" ref="image" class="max-w-[50vh] max-h-[50vh]"
      :src="getImageUrl(props.selection.adapter, props.selection.item.path)" alt="">
  </div>
...
const crossorigin = (import.meta.env.VITE_APP_MODE === "development") ? "use-credentials" : "anonymous"
